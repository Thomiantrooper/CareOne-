...
<html>
    ...
    <body>
        ...
        <div class="userbox">
            <font>
            <h2 class="h2text">~ <u>Sign up </u> ~</h2>
            </font>
            <div>
                <form method="post" action="createdoctor4"  id="registration-form" class="form-1">
                   <div class="boxdiv">
                    <input type="text" name="name"  placeholder="Name" class="box-1"> <br><br>
                    <input type="text" name="phonenumber"  placeholder="Phonenumber" class="box-1" maxlength="10"> <br><br>
                    ...
                    <input type="submit" name="submit" value="Create Account" class="submit-1">
                </form>
